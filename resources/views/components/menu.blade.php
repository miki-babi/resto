...
>
    ...
    <div class="flex min-h-screen items-center justify-center p-4" @click.self="isOpen = false">
        <div class="relative w-full max-w-2xl overflow-hidden rounded-3xl bg-white dark:bg-slate-900 shadow-2xl transition-all">
                    ...
                    <div class="h-full w-full">
                        ...
                        <template x-if="item.images.length > 1">
                            <div class="absolute inset-0 flex items-center justify-between px-4">
                                <button @click="prev()" class="rounded-full bg-white/20 p-2 text-white hover:bg-white/40">
                                ...
                                <button @click="next()" class="rounded-full bg-white/20 p-2 text-white hover:bg-white/40">
                        ...
                        <div class="absolute bottom-4 left-0 right-0 flex justify-center space-x-2">
                            <template x-for="(img, index) in item.images" :key="index">
                                <div :class="activeImage === index ? 'bg-white w-4' : 'bg-white/50 w-2'" class="h-2 rounded-full transition-all"></div>
                            </template>
                        </div>
                    </div>
                </template>
            ...
            <div class="p-8">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <p class="text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-6" x-text="item.description"></p>
