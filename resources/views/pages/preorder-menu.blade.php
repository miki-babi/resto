                    ...
                    x-data="{
                        ...
                        goToReview() {
                            if (!this.detailsComplete()) {
                                this.detailsError = 'Please complete all pickup details first.';
                                return;
                            }
                            this.detailsError = '';
                            this.step = 3;
                        ...
                        <div x-show="step === 3" x-cloak class="pb-20">
                            ...
                            <div class="space-y-4" x-show="cartItemCount() > 0">
                                ...
                                <div class="mt-12 p-10 rounded-3xl bg-gray-50 flex items-center justify-between border border-gray-100">
                                    ...
                                    <div class="text-right">
                                        <p class="text-xs font-black text-gray-400 uppercase tracking-[0.2em] mb-1 text-right">Pickup at</p>
                                        <p class="text-sm font-bold text-gray-900" x-text="`${selectedDate} at ${selectedTime}`"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
