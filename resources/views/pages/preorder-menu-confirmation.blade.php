<x-layouts.app-main>
    @push('meta')
        <meta name="description" content="Menu preorder confirmation">
        ...
        <div class="mx-auto max-w-4xl px-4 lg:px-6">
            <div class="rounded-3xl bg-white p-6 shadow-sm md:p-8">
                <div class="rounded-2xl border border-green-200 bg-green-50 px-4 py-3 text-sm font-medium text-green-800">
                    Preorder received successfully.
                </div>
                ...
                <h1 class="mt-6 text-2xl font-bold text-gray-900 md:text-3xl">Thank you for your preorder</h1>
